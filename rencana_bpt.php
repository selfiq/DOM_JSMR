  ...
  <div class="container body">
    <div class="main_container">
              ...
              <div class="x_panel">
                    ...
                    <div class="input-group buttonright" >
                      <div class="btn-group  buttonrightfloat " >
                        ...
                        <ul role="menu" class="dropdown-menu pull-right">
                          <li><a data-toggle="modal" data-target=".bs-program">Tambah Program</a></li>
	                        <li><a data-toggle="modal" data-target=".bs-subprogram" >Tambah Subprogram</a></li>
                ...
                <div class="x_content">
                  <table id="datatable-keytable"  class="table table-striped table-bordered " class="centered">
                    ...
                    <tbody>
                      <?php
                        //ambil data dari DB tw_rc
                        $listTW = mysqli_query($connect, "SELECT * FROM tw_rc, sub_program WHERE sub_program.id_sp = tw_rc.id_sp AND sub_program.id_cabang = '$idcabang' AND stat_twrc = '1'");
                        while($datalistTW = mysqli_fetch_array($listTW)){
                          $idpklist = $datalistTW['id_pk'];
                          $idspklist = $datalistTW['id_sp'];
                          $tahun= $datalistTW['tahun'];

                          //perhitungan jumlah rkap pada rencana
                          ...
                          //ambil data dari DB tw_rc untuk TW1, TW2, TW3, dan TW4
                ...
                <!-- end of tabel dan filter serta search -->
              </div>
            </div>
            <div class="clearfix"></div>
          </div>
      ...
      <!-- /page content -->
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="tambahprogram_bpt.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  <input name ="idcabang" type="text" id="idcabang" value="<?php echo $idcabang; ?>" hidden>
                  <!-- field from isi nomor MA-->
                  ...
                  <!-- end of field from isi nomor MA-->

                  <!-- field form isi nama program kerja-->
                  <div class="form-group">
                  ...
                  <!-- end offield form isi nama program kerja-->
					    </div>
        ...
        <div class="modal fade bs-subprogram" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="tambahsubprogram_bpt.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  <!-- field dependent dropdown list program kerja-->
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="programKerja">Program Kerja</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <!-- end of field dependent dropdown list program kerja-->

                  <!-- field dependent dropdown list sub program kerja-->
                  <div class="form-group">
                  ...
                  <!-- end of field dependent dropdown list sub program kerja-->
                </div>
                <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                <button type="submit" class="btn btn-primary" name="tambah">Simpan</button>
        ...
        <!-- end of Modal Tambah Subprogram -->
        ...
        <div class="modal fade bs-rencana" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="tambahrencana_bpt.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                  <!-- field dependent dropdown list program kerja -->
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="programKerja">Program Kerja</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <!-- end field dependent dropdown list sub program kerja -->

                  <!-- field form pilih tahun-->
                  <div class="form-group">
