<?php
	include 'connect.php';
		...
		$ceknama_subprogramkerja = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM sub_program WHERE id_pk = '$id_pk' AND nama_sp ='$nama_subpk'"));
...
<?php		
				...
				$insert= mysqli_query($connect,"INSERT INTO sub_program VALUES ('','$nama_subpk','$id_pk','$idcabang')");
