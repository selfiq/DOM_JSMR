                ...
                <div class="x_panel">
                      ...
                      <div class="input-group buttonright" >
                        <div class="btn-group  buttonrightfloat " >
                          ...
                          <ul role="menu" class="dropdown-menu pull-right">
                            <li><a data-toggle="modal" data-target=".bs-realisasi" >Tambah Realisasi</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="x_content">
                    <table id="datatable-keytable"  class="table table-striped table-bordered " class="centered">
                      ...
                      <tbody>
                        <?php
                        //mengambil data TW dari DB tw_real dan sub_program
                        $listTW = mysqli_query($connect, "SELECT * FROM tw_real, sub_program WHERE sub_program.id_sp = tw_real.id_sp AND sub_program.id_cabang = '$idcabang' AND stat_twrl ='1'");

                        while($datalistTW = mysqli_fetch_array($listTW)){
                          $idpklist= $datalistTW['id_pk'];  //menyimpan id program kerja ke dalam variabel
                          $idspklist= $datalistTW['id_sp']; //menyimpan id sub program kerja ke dalam variabel
                          $tahun= $datalistTW['tahun'];  //menyimpan tahun ke dalam variabel

                          //mengambil data dari DB tw_real untuk menghitung status akhir
                          $jmlstakhir = mysqli_query($connect, "SELECT * FROM tw_real WHERE id_sp = '$idspklist' AND tahun = '$tahun'");
                          //mengambil data dari DB tw_real untuk menghitung realisasi
                          $jmlrealisasi = mysqli_query($connect, "SELECT * FROM tw_real WHERE id_sp = '$idspklist' AND tahun = '$tahun'");

                          //perhitungan untuk total status akhir dan realiasi
                          $totalstakhir = 0;
								          $totalrealisasi = 0;
                          while ($num = mysqli_fetch_array($jmlstakhir)) {
                            $totalstakhir += $num['stat_akhir'];
                          }
                          while ($num = mysqli_fetch_array($jmlrealisasi)) {
                            $totalrealisasi += $num['realisasi'];
                          }
                          ...
                          //ambil data dari DB tw_real untuk TW1, TW2, TW3, dan TW4
                          $datatwreal1 = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM tw_real WHERE id_sp = '$idspklist' AND tahun = '$tahun' AND stat_twrl = '1'"));
                          $datatwreal2 = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM tw_real WHERE id_sp = '$idspklist' AND tahun = '$tahun' AND stat_twrl = '2'"));
                          $datatwreal3 = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM tw_real WHERE id_sp = '$idspklist' AND tahun = '$tahun' AND stat_twrl = '3'"));
                          $datatwreal4 = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM tw_real WHERE id_sp = '$idspklist' AND tahun = '$tahun' AND stat_twrl = '4'"));
                        ?>
                        <tr>
                          <td><?php echo $dataprogramkerja['nama_pk'] ?></td>
                          <td><?php echo $datasubprogramkerja['nama_sp'] ?></td>
                          <td><?php echo $totalstakhir;?></td>
                          <td><?php echo $totalrealisasi;?></td>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="tambahrealisasibeban.php" method="POST" id="demo-form2"  class="form-horizontal form-label-left">
                ...
                <!-- field dependent dropdown program kerja-->
                ...
                <!-- end of field dependent dropdown program kerja-->

                <!-- field dependent dropdown sub program kerja-->
						    <div class="form-group">
                ...
                <!-- end of field dependent dropdown sub program kerja-->
                ...
                <!-- end of field form triwulan  -->

                <!-- field form status akhir -->
						    <div class="form-group">
                ...
                <!-- end of field form status akhir -->

                <!-- field form realisasi -->
						    <div class="form-group">
