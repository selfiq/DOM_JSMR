<?php
	include 'connect.php';
		...
		$ceknama_subprogramkerja = mysqli_query($connect, "SELECT nama_sp FROM sub_program, program_kerja WHERE program_kerja.id_pk = '$idprogramkerja' AND nama_sp ='$nama_subpk'");
...
<?php }
		...
		//insert semua
		else $insert= mysqli_query($connect,"INSERT INTO sub_program VALUES ('','$nama_subpk','','','')");
		if($insert){
